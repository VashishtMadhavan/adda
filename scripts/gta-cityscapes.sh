...
echo 'GTA baseline:'
python tools/eval_segmentation.py gta val vgg_dilation snapshot/vgg_dilation_gta

echo 'ADDA':
python tools/eval_segmentation.py cityscapes val vgg_dilation snapshot/adda_vgg_dilation_gta_city
